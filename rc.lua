...
globalkeys = gears.table.join(
	...
	end, { description = "open file manager2", group = "launcher" }),
	...
	end, { description = "open pulsemixer", group = "launcher" }),
	awful.key({ modkey, "Shift" }, "m", function()
		awful.spawn.with_shell("mpc toggle")
	end, { description = "pauza/start", group = "music" }),
	...
	end, { description = "-10 s", group = "music" }),
	awful.key({ modkey, "Shift" }, ".", function()
		awful.spawn.with_shell("mpc seek +10")
	end, { description = "+10 s", group = "music" }),
	awful.key({ modkey, "Shift", "Control" }, ",", function()
		awful.spawn.with_shell("mpc seek -60")
	end, { description = "-60 s", group = "music" }),
	awful.key({ modkey, "Shift", "Control" }, ".", function()
		awful.spawn.with_shell("mpc seek +60")
	end, { description = "+60 s", group = "music" }),
	awful.key({ modkey }, "-", function()
		awful.spawn.with_shell("mpc volume -5")
	end, { description = "vol down", group = "music" }),
	awful.key({ modkey }, "=", function()
		awful.spawn.with_shell("mpc volume +5")
	end, { description = "vol up", group = "music" }),
	awful.key({ modkey, "Shift" }, "-", function()
	...
	awful.key({}, "Print", function()
		awful.spawn.with_shell("maimsc")
	end, { description = "selected area screenshot", group = "screen" }),
	awful.key({ modkey }, "m", function()
		awful.spawn("alacritty -e ncmpcpp")
	end, { description = "spawn music player", group = "music" }),
